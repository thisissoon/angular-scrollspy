...
describe('ScrollSpyService', () => {
  ...
  it('should add spy to list of spys', inject([ScrollSpyService], (service: ScrollSpyService) => {
  ...
  it('should remove spy from list of spys', inject([ScrollSpyService], (service: ScrollSpyService) => {
    const items = new QueryList<ScrollSpyItemDirective>();
    service.spys = [
      { id: 'foo', items },
      { id: 'bar', items }
  ...
  it('should set spy section status', inject([ScrollSpyService], (service: ScrollSpyService) => {
    const items1 = [{spyId: 'foo', section: 'section1', inViewport: false, active: false, detectChanges: () => {}}];
    const items2 = [{spyId: 'bar', section: 'section2', inViewport: true, active: true, detectChanges: () => {}}];
    service.spys = <any>[
      { id: 'foo', items: items1 },
      { id: 'bar', items: items2 }
    ];
  ...
  it('should NOT set spy section status if spy doesn\'t exist', inject([ScrollSpyService], (service: ScrollSpyService) => {
    const items1 = [{spyId: 'foo', section: 'section1', inViewport: false, active: false, detectChanges: () => {}}];
    const items2 = [{spyId: 'bar', section: 'section2', inViewport: false, active: false, detectChanges: () => {}}];
    service.spys = <any>[
      { id: 'foo', items: items1 },
      { id: 'bar', items: items2 }
    ];
    ...
    expect(service.buffer[0]).toEqual({ sectionId: 'section1', spyId: 'baz', inViewport: true });
  ...
  it('should clear buffer and update inViewport statuses', inject([ScrollSpyService], (service: ScrollSpyService) => {
    const items1 = [
      {spyId: 'foo', section: 'section1', inViewport: false, active: false, detectChanges: () => {}},
      {spyId: 'foo', section: 'section2', inViewport: false, active: false, detectChanges: () => {}}
    ];
    const items2 = [
      {spyId: 'bar', section: 'section1', inViewport: false, active: false, detectChanges: () => {}},
      {spyId: 'bar', section: 'section2', inViewport: false, active: false, detectChanges: () => {}}
    ];
    service.spys = [];
    ...
    expect(service.buffer.length).toBe(1);
    expect(service.buffer[0]).toEqual({ sectionId: 'section1', spyId: 'bar', inViewport: true });
